  ...
  allocations: [
    {
      ...
      amount: '400,000,000',
      color: 'bg-crimson',
      description: 'Distributed to community members and early supporters',
    },
    {
      ...
      amount: '300,000,000',
      color: 'bg-amber-600',
      description: 'Locked in DEX liquidity pools for trading',
    },
    {
      label: 'Development',
      percentage: 15,
    ...
    },
    {
      ...
      amount: '100,000,000',
      color: 'bg-blue-600',
      description: 'Allocated for marketing and partnerships',
    },
    {
  ...
  milestones: [
    {
      ...
      items: [
        ...
        'Community Discord and Telegram setup',
